...
L.UNKNOWN_CVAR_DROPPED = "%s is no longer a known cvar, dropping it"
...
L.SECURE = "%s is a secure cvar and cannot be changed by addons"
...
L.RAID_INACTIVE = "enabled but currently inactive"
L.RAID_DISABLED = "disabled"
L.ENCOUNTER_HEADER = "%s (%d settings)"
L.ENCOUNTER_HEADER_ONE = "%s (1 setting)"
L.SETTING_LINE = "  %s = %s"
